...
class ContraVoucherController extends Controller
{
    ...
    public function index()
    {
        ...
        if (Cache::get('count_trashed_cnt') && Cache::get('count_trashed_cnt') != null) {
            ...
            $data['count_trashed_cnt'] = $this->parentModel::onlyTrashed()->where('voucher_type', $this->voucher_type)->where('branch_id',$branch_id)->count();
    ...
    {  \Artisan::call('cache:clear');
        ...
        if (Cache::get('count_cnt') && Cache::get('count_cnt') != null) {
            ...
            $data['count_cnt'] = $this->parentModel::where('voucher_type', $this->voucher_type)->where('branch_id',$branch_id)->count();
    ...
    public function trashedSearch(Request $request)
    {
        ...
        if (Cache::get('count_cnt') && Cache::get('count_cnt') != null) {
            ...
            $data['count_cnt'] = $this->parentModel::onlyTrashed()->where('voucher_type', $this->voucher_type)->where('branch_id',$branch_id)->count();
            Cache::put('count_cnt', $data['count_cnt']);
        }
        $search = $request["search"];
