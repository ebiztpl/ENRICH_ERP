...
class NotesController extends Controller
{
    ...
    {\Artisan::call('cache:clear');
        ...
        if($branch_id != 1){
            $transaction_details = Helper::type_wise_transaction_details($request->income_expense_type_id, $branch_id, $request->start_from, $request->start_to);
        }else{
    ...
    {\Artisan::call('cache:clear');
        ...
        if($branch_id != 1){
        $transaction_details = Helper::group_wise_transaction_details($request->income_expense_group_id, $branch_id, $request->start_from, $request->start_to);
        }else{
