...
class CostOfRevenueController extends Controller
{
    ...
    {\Artisan::call('cache:clear');
        ...
        if($branch_id != 1){
            $from_amounts = Helper::totalAmountByLedgerType($code, $branch_id, $request->start_from, $request->start_to);
            $end_amounts = Helper::totalAmountByLedgerType($code, $branch_id, $request->end_from, $request->end_to);
