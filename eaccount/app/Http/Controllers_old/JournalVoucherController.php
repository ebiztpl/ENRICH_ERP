...
class JournalVoucherController extends Controller
{
    ...
    public function index()
    {
        ...
        if (Cache::get('count_trashed_jv') && Cache::get('count_trashed_jv') != null) {
            ...
            $data['count_trashed_jv'] = $this->parentModel::onlyTrashed()->where('voucher_type', $this->voucher_type)->where('branch_id',$branch_id)->count();
    ...
    public function trashed()
    {
        ...
        if (Cache::get('count_jv') && Cache::get('count_jv') != null) {
            ...
            $data['count_jv'] = $this->parentModel::onlyTrashed()->where('voucher_type', $this->voucher_type)->where('branch_id',$branch_id)->count();
