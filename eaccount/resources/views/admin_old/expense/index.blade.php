                                ...
                                <form class="form" id="form_validation" method="post"
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 field_area">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input autofocus="" value="{{ old('bill_date') }}" name="bill_no" type="text" id="bill_no" class="form-control">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line" id="foc">
                                                    <input name="total_amount" id="total_amount" type="number" value="{{ old('total_amount') }}"    class="form-control amount" readonly>
