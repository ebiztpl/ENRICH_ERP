                        ...
                        <div class="header">
                            ...
                            <div class="body">
                                <form class="form" id="form_validation" method="post"
                                    action="{{ route($ParentRouteName . '.expenseupdate', ['id' => $item->id]) }}" enctype="multipart/form-data" >
                                    {{ csrf_field() }}
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line" id="foc">
                                                    <input name="total_amount" id="total_amount" type="number" value="{{ $item->total }}"    class="form-control amount" readonly>
