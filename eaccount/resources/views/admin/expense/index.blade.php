    ...
    <section @if ($is_rtl) dir="rtl" @endif class="content">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb breadcrumb-col-cyan @if ($is_rtl) pull-left  @else pull-right @endif">
                ...
                <li><a href="{{ route('bill_recieved_list') }}"><i class="{{ $breadcrumbMainIcon }}"></i>
                        ...
                        <div class="header">
                            ...
                            <div class="body">
                                <form class="form" id="form_validation" method="post"
                                    action="{{ route($ParentRouteName . '.bill_recievedstore') }}" enctype="multipart/form-data" >
                                    {{ csrf_field() }}
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 field_area">
                                                ...
                                                <div class="form-line">
                                                    <select data-live-search="true" class="form-control show-tick"
                                                        ...
                                                        @foreach ($head as $group)
                                                            <option @if ($group->id == old('head')) selected @endif
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input autofocus="" value="{{ old('bill_no') }}" name="bill_no" type="text" id="bill_no" class="form-control">
                                        ...
                                        <div class="form-group form-float">
                                                <div class="form-line" id="bs_datepicker_container">
                                                    <input autocomplete="off" value="{{ old('bill_date') }}"
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input name="gst" id="gst" type="number" value="{{ old('gst') }}" class="form-control amount">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line" id="foc">
                                                    <input name="total_amount" id="total_amount" type="number" value="{{ old('total_amount') }}"    class="form-control amount" >
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                            <div class="form-group form-float">
                                                 @if(old('type'))
                                                 <input value="Goods" name="type" type="radio" id="radio_1" class="with-gap radio-col-cyan"  @if(old('type') == 'Goods')  checked="" @endif>
                                                <label for="radio_1">Goods</label>
                                                <input value="Services" name="type" type="radio" id="radio_2" class="with-gap radio-col-cyan"  @if(old('type') == 'Services')  checked="" @endif>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                            <div class="form-group form-float">
                                                ...
                                                <input value="1" name="tds" type="checkbox" id="tds" @if(old('tds') == '1')  checked="" @endif>
                                            ...
                                            <div class="form-group form-float">
                                                ...
                                                <select data-live-search="true" class="form-control show-tick"
                                                        ...
                                                        @foreach ($expense_paid as $ledg)
                                                            <option @if ($ledg->id == old('submitted_by')) selected @endif
                                        ...
                                        <div class="form-group form-float">
                                                <div class="form-line" id="bs_datepicker_container">
                                                    <input autocomplete="off" value="{{ old('submitted_date') }}"
                                        ...
                                        <div class="form-group form-float">
                                                <div class="form-line" id="bs_datepicker_container">
                                                    <input autocomplete="off" value="{{ old('approved_date') }}"
