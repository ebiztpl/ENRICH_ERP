                                    ...
                                    <table class="table table-hover table-bordered table-sm">
                                        <thead>
                                            <tr>
                                               ...
                                               <th>Sub head</th>
                                               <th>Ledger</th>
                                               <th style="width: 151px;display: block;">Bill Details</th>
                                               <!-- <th>Bill Date</th>
                                               <th>Bill Amount</th> -->
  
                                               <th>GST</th>
                                               <th style="width: 151px;display: block;">Amount Details</th>
                                               <!-- <th>Paid Amt.</th>
                                               <th>Balance</th> -->
...
$ledger =\DB::table('income_expense_heads')->where('id',$item->ledger)->value('name');
 @endphp                                              
                                               ...
                                               <td>
                                                    Bill No: {{ $item->bill_no }}<br>
                                                    Date: {{ date("d-m-Y", strtotime($item->bill_date)) }}<br>
  ...
  @endphp
                                             ...
                                             <td>
                                                Submitted By: {{ $expense_paid->name ?? '' }} {{ $expense_paid->surname ?? '' }}<br>
                                                Submitted Date: {{ date("d-m-Y", strtotime($item->submitted_date)) }}
                                            </td>
 
                                            
                                            <td>
    Approved By: {{ $expense_approve->name ?? '' }} {{ $expense_approve->surname ?? '' }}<br>
    Approved Date: {{ date("d-m-Y", strtotime($item->approved_date)) }}
</td>
