...
$moduleName = 'Direct Bill Received';
                        ...
                        <div class="header">
                            ...
                            <div class="body">
                                <form class="form" id="form_validation" method="post"
                                    action="{{ route($ParentRouteName . '.direct_bill_recievedstore') }}" enctype="multipart/form-data" >
                                    {{ csrf_field() }}
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 field_area">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line" >
                                                    <input name="new_column" id="new_column" type="number" value="{{ old('total_amount') }}"    class="form-control amount" >
                                                    <label class="form-label">New Column</label>
                                                </div>
                                            </div>
                                        </div>
