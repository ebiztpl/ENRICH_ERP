...
@endphp
    <section @if ($is_rtl) dir="rtl" @endif class="content">
        <div class="container-fluid">
            ...
            @if($branch_id == 1)  <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
        ...
        <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12   @if (config('role_manage.User.All') == 0 and
                    config('role_manage.User.TrashShow') == 0 and
                    config('role_manage.User.Create') == 0) dis-none @endif  ">    
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="button-demo">
                              ...
                              @if($branch_id == 1)   <a href="{{ route('jnl_voucher') }}" type="button"
                                ...
                                <a href="{{ route('contra_voucher') }}" type="button"
                                    class="btn bg-orange waves-effect">{{ __('root.dashboard.quick_access_contra_voucher') }}</a>@endif
                            </div>
                        </div>
                    </div>
                </div>
