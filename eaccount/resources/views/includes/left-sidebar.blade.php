...
@if($branchid == 1)
                                ...
                                <li @if (Request::url() === route('income_expense_head.linking') ) class="active" @endif>
                                    <a 
                                        href="{{ route('income_expense_head.linking') }}">Ledger Branches</a>
                                </li>
                                @endif
...
<li >
    ...
    <ul class="ml-menu">
        <li>
            <a
                href="{{ route('session_budget') }}">Session Budget</a>
        </li>
      <!--  <li>
                            <a
                                href="{{ route('session_budget_list') }}">Session Budget List</a>
                        </li> -->
                        ...
                        <li>
                            <a
                                href="{{ route('session_budget_report') }}">Budget Report</a>
                        </li>
        ...
        <div class="legal">
            <div class="copyright">
                {{ config('settings.developed_label') }} 
            </div>
            <div class="version">
            <a target="_blank"
