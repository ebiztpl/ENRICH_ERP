...
Route::group(['middleware' => 'auth'], function () {
    ...
    */
    ...
    // Route::post('/ledger/name/gettypegroup', [
    //     'uses' => 'IncomeExpenseHeadController@gettypegroup',
    //     'as' => 'gettypegroup'
    // ]);
...
// payment mode create 	
    ...
    Route::get('/ledger/name/linking', [
        'uses' => 'IncomeExpenseHeadController@linking',
        'as' => 'income_expense_head.linking'
    ])->middleware('income_expense_head.trash_show');

    Route::post('/ledger/name/linking/savelinking', [
        'uses' => 'IncomeExpenseHeadController@savelinking',
        'as' => 'income_expense_head.linking.savelinking'
    ])->middleware('income_expense_head.trash_show');


    Route::post('/ledger/group/savesubgroup', [
        'uses' => 'IncomeExpenseGroupController@savesubgroup',
        'as' => 'income_expense_group.savesubgroup'
    ])->middleware('income_expense_group.all');

    Route::post('/ledger/group/editsubgroup', [
        'uses' => 'IncomeExpenseGroupController@editsubgroup',
        'as' => 'income_expense_group.editsubgroup'
    ])->middleware('income_expense_group.all');

    Route::post('/ledger/group/subgroup_delete', [
        'uses' => 'IncomeExpenseGroupController@subgroup_delete',
        'as' => 'income_expense_group.subgroup_delete'
    ])->middleware('income_expense_group.all');


    
    Route::post('/ledger/group/savesubgroup0', [
        'uses' => 'IncomeExpenseGroupController@savesubgroup0',
        'as' => 'income_expense_group.savesubgroup0'
    ])->middleware('income_expense_group.all');




    Route::get('/bank-cash/linking/{id}', [
        'uses' => 'BankCashController@linking',
        'as' => 'bank_cash.linking'
    ])->middleware('bank_cash.edit');

    
    Route::post('/bank-cash/linkingsave/{id}', [
        'uses' => 'BankCashController@linkingsave',
        'as' => 'bank_cash.linkingsave'
    ])->middleware('bank_cash.edit');
    ...
    // language crud
    Route::get('/bill_recieved', [
        'uses' => 'LanguageController@bill_recieved',
        'as' => 'bill_recieved'
    ])->middleware('language.module_show');

    Route::post('/bill_recieved/store', [
        'uses' => 'LanguageController@bill_recievedstore',
        'as' => 'bill_recieved.bill_recievedstore'
    ])->middleware('language.create');

    Route::post('/bill_recieved/bill_recievedsubfilter', [
        'uses' => 'LanguageController@bill_recievedsubfilter',
        'as' => 'bill_recieved.bill_recievedsubfilter'
    ])->middleware('language.create');
    
    Route::post('/bill_recieved/createnewlaser', [
        'uses' => 'LanguageController@createnewlaser',
        'as' => 'bill_recieved.createnewlaser'
    ])->middleware('language.create');
    
    Route::get('/bill_recieved_list', [
        'uses' => 'LanguageController@bill_recieved_list',
        'as' => 'bill_recieved_list'
    ])->middleware('language.module_show');

    Route::get('/language/editexpense/{id}', [
        'uses' => 'LanguageController@editexpense',
        'as' => 'language.editexpense'
    ])->middleware('language.edit');
    
    Route::post('/bill_recieved/expenseupdate/{id}', [
        'uses' => 'LanguageController@expenseupdate',
        'as' => 'bill_recieved.expenseupdate'
    ])->middleware('language.edit');

    
    Route::post('/bill_recieved/bill_paymentstore', [
        'uses' => 'LanguageController@bill_paymentstore',
        'as' => 'language.bill_paymentstore'
    ])->middleware('language.create');


    Route::post('/bill_recieved/viewbillpayments', [
        'uses' => 'LanguageController@viewbillpayments',
        'as' => 'language.viewbillpayments'
    ])->middleware('language.create');



    Route::any('/bill_recieved_listt', [
        'uses' => 'LanguageController@bill_recieved_list',
        'as' => 'bill_recieved_listt'
    ])->middleware('language.module_show');

    
    
    Route::post('/bill_recieved/bill_recievedledger', [
        'uses' => 'LanguageController@bill_recievedledger',
        'as' => 'bill_recieved.bill_recievedledger'
    ])->middleware('language.create');

    Route::get('/language/deleteexpense/{id}', [
        'uses' => 'LanguageController@deleteexpense',
        'as' => 'language.deleteexpense'
    ])->middleware('language.edit');
    

    

    Route::get('/session_budget', [
        'uses' => 'LanguageController@session_budget',
        'as' => 'session_budget'
    ])->middleware('language.module_show');

    

    Route::post('/session_budget/session_store', [
        'uses' => 'LanguageController@session_store',
        'as' => 'bill_recieved.session_store'
    ])->middleware('language.create');


    
    Route::get('/session_budget_list', [
        'uses' => 'LanguageController@session_budget_list',
        'as' => 'session_budget_list'
    ])->middleware('language.module_show');

    

    Route::get('/language/editsession/{id}', [
        'uses' => 'LanguageController@editsession',
        'as' => 'bill_recieved.editsession'
    ])->middleware('language.edit');

    
    Route::get('/language/deletesession/{id}', [
        'uses' => 'LanguageController@deletesession',
        'as' => 'bill_recieved.deletesession'
    ])->middleware('language.edit');

    

   Route::post('/bill_recieved/session_update/{id}', [
        'uses' => 'LanguageController@session_update',
        'as' => 'bill_recieved.session_update'
    ])->middleware('language.edit');

    
        
    Route::any('/session_budget_report', [
        'uses' => 'LanguageController@session_budget_report',
        'as' => 'session_budget_report'
    ])->middleware('language.module_show');
});
