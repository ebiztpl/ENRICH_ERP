...
<?php $__env->startSection('content'); ?>
    ...
    <div class="mid">
        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $income_expense_head): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($income_expense_head->Transaction->count() > 0): ?>
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
                        <h4 class="text-center mb-3"><?php echo e($income_expense_head->name); ?></h4>
                        <table class="table table-bordered table-sm table-hover">
                            ...
                            <tbody>
                                <?php
                                    $balance = 0;
                                ?>
                                <?php $__currentLoopData = $income_expense_head->Transaction; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($income_expense_head->type): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><?php echo e(Helper::convertMoneyFormat($transaction->dr)); ?>

                                        </td>
                                        <td class="text-right"><?php echo e(Helper::convertMoneyFormat($transaction->cr)); ?>

                                        </td>
                                        <td class="text-right"><?php echo e(Helper::convertMoneyFormat($balance)); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <th class="text-right" colspan="10">Total =</th>
                                    <th class="text-right"><?php echo e(Helper::convertMoneyFormat($balance)); ?></th>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<?php echo $__env->make('layouts.pdf', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/enrichapp.co.in/httpdocs/eaccount/resources/views/admin/accounts-report/ledger/income-expense-head-wise/index.blade.php ENDPATH**/ ?>