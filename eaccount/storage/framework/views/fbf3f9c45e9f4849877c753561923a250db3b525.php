                            ...
                            <ul class="header-dropdown m-r--5">
                                <form class="search" action="<?php echo e(route($ParentRouteName . '.active.search')); ?>"
                                    ...
                                    <input autofocus type="search" name="search" class="form-control input-sm "
                                        placeholder="<?php echo e(__('root.common.search')); ?> Group" />
                                </form>
                            </ul>
                        </div>
                                    ...
                                    <table  id="tree-table"  class="table table-hover table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr data-id="<?php echo e($item->id); ?><?php echo e($item->name); ?>" data-parent="0" data-level="1">
                                                    <td class="text-center" data-column="name"> 
                                                        ...
                                                        <label for="md_checkbox_<?php echo e($i); ?>"></label> --><?= $i ?>
</td>
                                                    ...
                                                    <td class="">
                                                        ...
                                                        <a <?php if($pdf == 0): ?> class="dis-none" <?php endif; ?>
                                                            ...
                                                            href="javascript:void(0)" id="<?php echo e($item->id); ?>"
                                                            data-toggle="tooltip" data-placement="top"
                                                            title="Add Sub-group"> 
                                                            <i
                                                       ...
                                                       ?>
                                                       <?php $__currentLoopData = $dropers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                       <tr data-id="<?php echo e($itemm->id); ?>" data-parent="<?php echo e($item->id); ?><?php echo e($item->name); ?>" data-level="2" style="background-color:#b9d5ed">
                                                    <td class="text-center" data-column="name" > 
                                                        
</td>
                                                    <td ><?php echo e($itemm->name); ?></td>
                                                    <!-- <?php
                                                    ...
                                                    <td class="">
                                                        <a <?php if($edit == 0): ?> class="dis-none" <?php endif; ?>
                                                            ...
                                                            href="javascript:void(0)" id="<?php echo e($itemm->id); ?>" data-id="<?php echo e($itemm->name); ?>"
                                                            data-toggle="tooltip" data-placement="top"
                                                            title="<?php echo e(__('root.common.edit')); ?> Subgroup"><i
                                                                class="material-icons">mode_edit</i></a>
                                                        <!-- <a <?php if($show == 0): ?> class="dis-none" <?php endif; ?>
                                                            target="_blank" data-target="#largeModal"
                                                            class="btn btn-xs btn-success waves-effect ajaxCall dis-none"
                                                            href="<?php echo e(route($ParentRouteName . '.show', ['id' => $itemm->id])); ?>"
                                                            data-toggle="tooltip" data-placement="top"
                                                            title="<?php echo e(__('root.common.preview')); ?>"><i
                                                                class="material-icons">pageview</i></a> -->
                                                        <a <?php if($delete == 0): ?> class="dis-none" <?php endif; ?>
                                                            class="btn btn-xs btn-danger waves-effect subgroup_delete"
                                                            href="javascript:void(0)" id="<?php echo e($itemm->id); ?>"
                                                            data-toggle="tooltip" data-placement="top"
                                                            title="<?php echo e(__('root.common.trash')); ?>"> <i
                                                                class="material-icons">delete</i></a>
                                                        <!-- <a <?php if($pdf == 0): ?> class="dis-none" <?php endif; ?>
                                                            class="btn btn-xs btn-warning waves-effect"
                                                            href="<?php echo e(route($ParentRouteName . '.pdf', ['id' => $itemm->id])); ?>"
                                                            data-toggle="tooltip" data-placement="top"
                                                            title="<?php echo e(__('root.common.pdf_generator')); ?>"> <i
                                                                class="material-icons">picture_as_pdf</i></a> -->
                                                ...
                                                <?php
                                                       ...
                                                       ?>
                                                       <?php $__currentLoopData = $dropers2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemmm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                       <tr data-id="<?php echo e($itemmm->id); ?>" data-parent="<?php echo e($itemm->id); ?>" data-level="3" style="background-color:#e4cfb7">
                                                    <td class="text-center" data-column="name"> 
                                                        
</td>
                                                    <td ><?php echo e($itemmm->name); ?></td>
                                                    <!-- <?php
                                                    $type = \DB::table('income_expense_types')->value('name');
                                                    ?> -->
                                                    <td></td>
                                                    ...
                                                    <a <?php if($edit == 0): ?> class="dis-none" <?php endif; ?>
                                                            class="btn btn-xs btn-info waves-effect edit_subgroup"
                                                            href="javascript:void(0)" id="<?php echo e($itemmm->id); ?>" data-id="<?php echo e($itemmm->name); ?>"
                                                            data-toggle="tooltip" data-placement="top"
                                                            title="<?php echo e(__('root.common.edit')); ?> Subgroup"><i
                                                                class="material-icons">mode_edit</i></a>
                                                                ...
                                                                <a <?php if($delete == 0): ?> class="dis-none" <?php endif; ?>
                                                            class="btn btn-xs btn-danger waves-effect subgroup_delete"
                                                            href="javascript:void(0)" id="<?php echo e($itemmm->id); ?>"
                                                            data-toggle="tooltip" data-placement="top"
                                                            title="<?php echo e(__('root.common.trash')); ?>"> <i
                                                                class="material-icons">delete</i></a>
                                                        <!--<a <?php if($show == 0): ?> class="dis-none" <?php endif; ?>
                                                            target="_blank" data-target="#largeModal"
                                                            class="btn btn-xs btn-success waves-effect ajaxCall dis-none"
                                                            href="<?php echo e(route($ParentRouteName . '.show', ['id' => $itemmm->id])); ?>"
                                                            data-toggle="tooltip" data-placement="top"
                                                            title="<?php echo e(__('root.common.preview')); ?>"><i
                                                                class="material-icons">pageview</i></a>
                                                        ...
                                                        <a <?php if($pdf == 0): ?> class="dis-none" <?php endif; ?>
                                                            class="btn btn-xs btn-warning waves-effect"
                                                            href="<?php echo e(route($ParentRouteName . '.pdf', ['id' => $itemmm->id])); ?>"
                                                            data-toggle="tooltip" data-placement="top"
                                                            title="<?php echo e(__('root.common.pdf_generator')); ?>"> <i
                                                                class="material-icons">picture_as_pdf</i></a> -->
                                                ...
                                                <?php
                                                       ...
                                                       ?>
                                                       <?php $__currentLoopData = $dropers3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemmmm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                       <tr data-id="<?php echo e($itemmmm->id); ?>" data-parent="<?php echo e($itemmm->id); ?>" data-level="4" style="background-color:#bdb76b36">
                                                    <td class="text-center" data-column="name"> 
                                                        
</td>
                                                    <td ><?php echo e($itemmmm->name); ?></td>
                                                    <!-- <?php
                                                    $type = \DB::table('income_expense_types')->value('name');
                                                    ?> -->
                                                    <td></td>
                                                    ...
                                                    <a <?php if($edit == 0): ?> class="dis-none" <?php endif; ?>
                                                            class="btn btn-xs btn-info waves-effect edit_subgroup"
                                                            href="javascript:void(0)" id="<?php echo e($itemmmm->id); ?>" data-id="<?php echo e($itemmmm->name); ?>"
                                                            data-toggle="tooltip" data-placement="top"
                                                            title="<?php echo e(__('root.common.edit')); ?> Subgroup"><i
                                                                class="material-icons">mode_edit</i></a>
                                                                ...
                                                                <a <?php if($delete == 0): ?> class="dis-none" <?php endif; ?>
                                                            class="btn btn-xs btn-danger waves-effect subgroup_delete"
                                                            href="javascript:void(0)" id="<?php echo e($itemmmm->id); ?>"
                                                            data-toggle="tooltip" data-placement="top"
                                                            title="<?php echo e(__('root.common.trash')); ?>"> <i
                                                                class="material-icons">delete</i></a>
                                                        <!--<a <?php if($show == 0): ?> class="dis-none" <?php endif; ?>
                                                ...
                                                <?php
                                                       ...
                                                       ?>
                                                       <?php $__currentLoopData = $dropers4; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemmmmm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                       <tr data-id="<?php echo e($itemmmmm->id); ?>" data-parent="<?php echo e($itemmmm->id); ?>" data-level="5" style="background-color:#e6e6e6">
                                                    <td class="text-center" data-column="name"> 
                                                        
</td>
                                                    <td ><?php echo e($itemmmmm->name); ?></td>
                                                    <!-- <?php
                                                    $type = \DB::table('income_expense_types')->value('name');
                                                    ?> -->
                                                    <td></td>
                                                    ...
                                                    <a <?php if($edit == 0): ?> class="dis-none" <?php endif; ?>
                                                            class="btn btn-xs btn-info waves-effect edit_subgroup"
                                                            href="javascript:void(0)" id="<?php echo e($itemmmmm->id); ?>" data-id="<?php echo e($itemmmmm->name); ?>"
                                                            data-toggle="tooltip" data-placement="top"
                                                            title="<?php echo e(__('root.common.edit')); ?> Subgroup"><i
                                                                class="material-icons">mode_edit</i></a>
                                                                ...
                                                                <a <?php if($delete == 0): ?> class="dis-none" <?php endif; ?>
                                                            class="btn btn-xs btn-danger waves-effect subgroup_delete"
                                                            href="javascript:void(0)" id="<?php echo e($itemmmmm->id); ?>"
                                                            data-toggle="tooltip" data-placement="top"
                                                            title="<?php echo e(__('root.common.trash')); ?>"> <i
                                                                class="material-icons">delete</i></a>
                                                        <!--<a <?php if($show == 0): ?> class="dis-none" <?php endif; ?>
...
<?php $__env->startPush('include-js'); ?>
  ...
  if (person != null) {
    ...
    $.ajax({
            ...
            url: "<?php echo e(route($ParentRouteName . '.savesubgroup')); ?>",
            data: {
                data: $data,
                person: person,
...
<script>
  ...
  if (person != null) {
    ...
    $.ajax({
            type: 'POST',
            headers: {'X-CSRF-Token': $('meta[name="csrf-token"]').attr('content')},
            url: "<?php echo e(route($ParentRouteName . '.editsubgroup')); ?>",
            data: {
                data: $data,
                person: person,
...
<script>  
  $(document).on('click', '.subgroup_delete', function() {
    ...
    $.ajax({
            type: 'POST',
            headers: {'X-CSRF-Token': $('meta[name="csrf-token"]').attr('content')},
            url: "<?php echo e(route($ParentRouteName . '.subgroup_delete')); ?>",
            data: {
                data: $data,
            },
            success: function(response) {
...
<script>
  ...
  if (person != null) {
    ...
    $.ajax({
            type: 'POST',
            headers: {'X-CSRF-Token': $('meta[name="csrf-token"]').attr('content')},
            url: "<?php echo e(route($ParentRouteName . '.savesubgroup0')); ?>",
            data: {
                data: $data,
                person: person,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/enrichapp.co.in/httpdocs/eaccount/resources/views/admin/income-expense-group/index.blade.php ENDPATH**/ ?>