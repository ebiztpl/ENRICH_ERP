<section>
 ...
 <!-- custom code byb hritik -->
        ...
        <div class="legal">
            <div class="copyright">
                <?php echo e(config('settings.developed_label')); ?> <a target="_blank"
                    href="<?php echo e(config('settings.developed_link')); ?>"><?php echo e(config('settings.developed_by')); ?></a>
            </div>
            <div class="version">
                <b>Version: </b> <?php echo e(config('settings.version')); ?>
...
<?php /**PATH D:\xampp\htdocs\madhaverp_13_11\eaccount\resources\views/includes/left-sidebar.blade.php ENDPATH**/ ?>