                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                <form class="form" id="form_validation" method="post"
                                      action="<?php echo e(route('reports.general.ledger.type.report')); ?>">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                <form class="form" id="form_validation" method="post"
                                      action="<?php echo e(route('reports.general.ledger.group.report')); ?>">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                <form class="form" id="form_validation" method="post"
                                      action="<?php echo e(route('reports.general.ledger.name.report')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/enrichapp.co.in/httpdocs/eaccount/resources/views/admin/general-report/ledger/index.blade.php ENDPATH**/ ?>