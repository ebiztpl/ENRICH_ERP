                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <a <?php if($trash_show == 0): ?> class="dis-none" <?php endif; ?>
                                ...
                                href="<?php echo e(route($ParentRouteName)); ?>"><?php echo e(__('root.common.trash')); ?>(<?php echo e($count_trashed_cnt); ?>
                                    ...
                                    <table class="table table-hover table-bordered table-sm">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center"><?php echo e(__('root.contra_voucher.voucher_no')); ?></th>
                                                <th><?php echo e(__('root.contra_voucher.particulars')); ?></th>
                                                <th><?php echo e(__('root.contra_voucher.branch_name')); ?></th>
                                                <th><?php echo e(__('root.contra_voucher.date')); ?></th>
                                                <th><?php echo e(__('root.contra_voucher.head_of_account_name')); ?></th>
                                                <th><?php echo e(__('root.contra_voucher.made_of_payment')); ?></th>
                                                <th><?php echo e(__('root.contra_voucher.chq_no')); ?></th>
                                                <th><?php echo e(__('root.contra_voucher.amount')); ?> ( <?php echo config('settings.is_code') == 'code' ? config('settings.currency_code') : config('settings.currency_symbol'); ?>
                                                    )
                                                </th>
                                                <th><?php echo e(__('root.contra_voucher.options')); ?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php $i = 1; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/enrichapp.co.in/httpdocs/eaccount/resources/views/admin/cnt-voucher/index.blade.php ENDPATH**/ ?>