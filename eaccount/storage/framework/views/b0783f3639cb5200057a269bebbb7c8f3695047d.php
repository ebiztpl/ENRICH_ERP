                    ...
                    <div class="card">
                        <div class="header">
                            <a <?php if($all == 0): ?> class="dis-none" <?php endif; ?>
                                ...
                                href="<?php echo e(route($ParentRouteName)); ?>"><?php echo e(__('root.common.all')); ?>(<?php echo e($total_income_expense_heads); ?>)</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/enrichapp.co.in/httpdocs/eaccount/resources/views/admin/income-expense-head/trashed.blade.php ENDPATH**/ ?>