                    ...
                    <div class="card">
                        <div class="header">
                            <a <?php if($all == 0): ?> class="dis-none" <?php endif; ?>
                                ...
                                href="<?php echo e(route($ParentRouteName)); ?>"><?php echo e(__('root.common.all')); ?>(<?php echo e($count_cv); ?>)</a>
                                    ...
                                    <table class="table table-hover table-bordered table-sm">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center"><?php echo e(__('root.cr_voucher.voucher_no')); ?></th>
                                                <th><?php echo e(__('root.cr_voucher.particulars')); ?></th>
                                                <th><?php echo e(__('root.cr_voucher.branch_name')); ?></th>
                                                <th><?php echo e(__('root.cr_voucher.date')); ?></th>
                                                <th><?php echo e(__('root.cr_voucher.head_of_account_name')); ?></th>
                                                <th><?php echo e(__('root.cr_voucher.made_of_payment')); ?></th>
                                                <th><?php echo e(__('root.cr_voucher.chq_no')); ?></th>
                                                <th><?php echo e(__('root.cr_voucher.amount')); ?> ( <?php echo config('settings.is_code') == 'code' ? config('settings.currency_code') : config('settings.currency_symbol'); ?>
                                                    )
                                                </th>
                                                <th><?php echo e(__('root.cr_voucher.options')); ?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php $i = 1; ?>
                                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <?php echo e($item->BankCash != null ? $item->BankCash->name : ''); ?> </td>
                                                    ...
                                                    <td class="tdAction">
                                                        <a <?php if($restore == 0): ?> class="dis-none" <?php endif; ?>
                                                            ...
                                                            href="<?php echo e(route($ParentRouteName . '.restore', ['id' => $item->voucher_no])); ?>"
                                                        ...
                                                        <a <?php if($permanently_delete == 0): ?> class="dis-none" <?php endif; ?>
                                                            ...
                                                            href="<?php echo e(route($ParentRouteName . '.kill', ['id' => $item->voucher_no])); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\madhaverp_13_11\eaccount\resources\views/admin/cr-voucher/trashed.blade.php ENDPATH**/ ?>