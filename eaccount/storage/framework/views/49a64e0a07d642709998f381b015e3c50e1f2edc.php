                    ...
                    <tbody>
                        <?php $__currentLoopData = $particulars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $particular): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td <?php if($key == 'Revenue' or
                                    $key == 'GrossProfit' or
                                    $key == 'IncomeFromOperation' or
                                    $key == 'IncomeBeforeTaxAndInterest' or
                                    $key == 'IncomeAfterTaxAndInterest'): ?> <?php elseif($key == 'NetProfitOrLoss'): ?> <?php endif; ?>
                                    class="text-left" scope="row"><?php echo e($particular['name']); ?></td>
                                <td <?php if($key == 'Revenue' or
                                    $key == 'GrossProfit' or
                                    $key == 'IncomeFromOperation' or
                                    $key == 'IncomeBeforeTaxAndInterest' or
                                    $key == 'IncomeAfterTaxAndInterest'): ?> <?php elseif($key == 'NetProfitOrLoss'): ?> <?php endif; ?>
                                    scope="row" class=" text-right"><?php echo e($particular['balance']['start_balance']); ?> </td>
                                <td <?php if($key == 'Revenue' or
                                    $key == 'GrossProfit' or
                                    $key == 'IncomeFromOperation' or
                                    $key == 'IncomeBeforeTaxAndInterest' or
                                    $key == 'IncomeAfterTaxAndInterest'): ?> <?php elseif($key == 'NetProfitOrLoss'): ?> <?php endif; ?>
                                    class="text-right"><?php echo e($particular['balance']['end_balance']); ?> </td>
                            </tr>
...
<?php echo $__env->make('layouts.pdf', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/enrichapp.co.in/httpdocs/eaccount/resources/views/admin/accounts-report/balance-sheet/branch-wise/exl.blade.php ENDPATH**/ ?>