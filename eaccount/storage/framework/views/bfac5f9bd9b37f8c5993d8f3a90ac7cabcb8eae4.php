                                ...
                                <form class="form" id="form_validation" method="post"
                                    ...
                                    <div class="row clearfix">
                                                ...
                                                <div class="form-line">
                                                    <select data-live-search="true" class="form-control  show-tick"
                                                        ...
                                                        <?php $__currentLoopData = $income_expense_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $income_expense_type_id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option <?php if($income_expense_type_id->id == old('income_expense_type_id')): ?> selected <?php endif; ?>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line" id="append_select"> 
                                                    <select data-live-search="true" class="form-control  show-tick"
                                                        ...
                                                        <?php $__currentLoopData = $income_expense_groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $income_expense_group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option <?php if($income_expense_group->id == old('income_expense_group_id')): ?> selected <?php endif; ?>
                                                                value="<?php echo e($income_expense_group->id); ?>" data-id="<?php echo e($income_expense_group->income_expense_type); ?>">
                                                                <?php echo e($income_expense_group->name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="<?php echo e(old('unit')); ?>" name="unit" type="text"
                                                        class="form-control">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/enrichapp.co.in/httpdocs/eaccount/resources/views/admin/income-expense-head/create.blade.php ENDPATH**/ ?>