    ...
    <div class="container-fluid">
        <div <?php if($is_rtl): ?> dir="rtl"  <?php endif; ?> class="rtl-supported-navbar">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo e(route('dashboard')); ?>"><?php echo Config::get('settings.company_name'); ?></a>
            </div>
            <div>
...
<?php /**PATH D:\xampp\htdocs\madhaverp_13_11\eaccount\resources\views/includes/top-bar.blade.php ENDPATH**/ ?>