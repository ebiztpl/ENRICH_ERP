                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <a <?php if($trash_show == 0): ?> class="dis-none" <?php endif; ?>
                                ...
                                href="<?php echo e(route($ParentRouteName)); ?>"><?php echo e(__('root.common.trash')); ?>(<?php echo e($total_trashed_bank_cashes); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tdTrashAction">
                                                        ...
                                                        <a <?php if($pdf == 0): ?> class="dis-none" <?php endif; ?>
                                                            class="btn btn-xs btn-warning waves-effect" target="blank"
														...
														<?php if($branch_id == 1): ?>
                                                            ...
                                                            href="<?php echo e(route($ParentRouteName . '.linking', ['id' => $item->id])); ?>"
                                                            data-toggle="tooltip" data-placement="top"
                                                            title="Branch Linking"><i
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/enrichapp.co.in/httpdocs/eaccount/resources/views/admin/bank-cash/index.blade.php ENDPATH**/ ?>