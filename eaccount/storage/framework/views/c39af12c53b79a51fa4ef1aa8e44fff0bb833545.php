                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <table class="table  table-bordered table-hover">
                                <thead>
                                <tr>
                                    <td> Branch Name: &nbsp; <span class="text-bold"><?php echo e(App\Transaction::find($items[0]->id)->Branch->name); ?></span>
                                    </td>
                                    <td> Made Of Payment: &nbsp; <span class="text-bold"><?php echo e(App\Transaction::find($items[0]->id)->BankCash->name); ?></span>
                                    </td>
                                    <td>Particulars: &nbsp; <span class="text-bold"><?php echo e($items[0]->particulars); ?></span></td>
                                    <td> Voucher Date: &nbsp; <span class="text-bold"><?php echo e(date(Config('settings.date_format'), strtotime($items[0]->voucher_date))); ?></span>
                                    </td>
                                </tr>
                                </thead>
                            </table>
                            ...
                            <table class="table  table-bordered table-hover">
                                ...
                                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <th> <?php echo e($transaction->convert_money_format($amount)); ?></th>
                        ...
                        <div class="body">
                            <table class="table  table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>Created at: &nbsp; <span class="text-bold"><?php echo e(date(config('settings.date_format')." h:i:s", strtotime($items[0]->created_at))); ?></span>  </td>
                                    ...
                                    <td>Modified at: &nbsp; <span class="text-bold"><?php echo e(date(config('settings.date_format')." h:i:s", strtotime($items[0]->updated_at))); ?></span> </td>
                                </tr>
                                </thead>
                            </table>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/enrichapp.co.in/httpdocs/eaccount/resources/views/admin/dr-voucher/show.blade.php ENDPATH**/ ?>