...
<?php $__env->startSection('title'); ?>
    <?php echo e(__('root.reports.fixed_assets_schedule_manage')); ?>
...
<?php $__env->startSection('content'); ?>
    <section <?php if($is_rtl): ?> dir="rtl" <?php endif; ?> class="content">
        <div class="header">
            <h2 class="text-center"><?php echo e(__('root.reports.fixed_assets_schedule_manage')); ?></h2>
        </div>
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <form class="form" id="form_validation" method="post"
                                    action="<?php echo e(route('reports.accounts.fixed_asset_schedule.report')); ?>">
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <select data-live-search="true" class="form-control show-tick"
                                                    name="branch_id">
                                                    <option value="0"><?php echo e(__('root.reports.select_branch_name')); ?></option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\madhaverp_13_11\eaccount\resources\views/admin/accounts-report/fixed-asset-schedule/index.blade.php ENDPATH**/ ?>