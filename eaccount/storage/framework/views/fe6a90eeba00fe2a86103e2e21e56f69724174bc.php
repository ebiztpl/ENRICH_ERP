...
$password = ''; 
    $dis = "";
    // $url =  'http://localhost/madhaverp_13_11/admin/admin/dashboard'; // this can be set based on whatever
    // // no redirect
    // header( "Location: $url" );
    // exit;
...
<?php echo $__env->make('layouts.etemplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\madhaverp_13_11\eaccount\resources\views/auth/login.blade.php ENDPATH**/ ?>