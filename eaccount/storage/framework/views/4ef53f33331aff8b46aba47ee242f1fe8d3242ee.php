                    ...
                    <div class="card">
                        <div class="header">
                            <a class="btn btn-xs btn-info waves-effect"
                                href="<?php echo e(route($ParentRouteName)); ?>"><?php echo e(__('root.common.all')); ?>(<?php echo e($total_language); ?>)</a>
                            <a <?php if($trash_show == 0): ?> class="dis-none" <?php endif; ?>
                                class="btn btn-xs btn-danger waves-effect text-black"
                                href="<?php echo e(route($ParentRouteName)); ?>"><?php echo e(__('root.common.trash')); ?>(<?php echo e($total_trashed_language); ?>
                                    ...
                                    <table class="table table-hover table-bordered table-sm">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo e(__('root.language.name')); ?></th>
                                                <th><?php echo e(__('root.language.code')); ?></th>
                                                <th><?php echo e(__('root.language.country_name')); ?></th>
                                                <th class="text-center"><?php echo e(__('root.language.set_as_default')); ?></th>
                                                <th><?php echo e(__('root.language.options')); ?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php $i = 1; ?>
                                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="switch">
                                                            <label>
                                                                <input class="set_as_default" value="<?php echo e($item->id); ?>"
                                                                    <?php if($item->is_default): ?> checked <?php endif; ?>
                                                                    name="set_as_default-<?php echo e($item->id); ?>"
                                                                    type="checkbox">
                                                    ...
                                                    <td class="tdTrashAction">
                                                        ...
                                                        <a class="btn btn-xs btn-warning waves-effect"
                                                            href="<?php echo e(route('language.configureLang', $item->id)); ?>"
                                                            data-toggle="tooltip" data-placement="top"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\madhaverp_13_11\eaccount\resources\views/admin/language/index.blade.php ENDPATH**/ ?>