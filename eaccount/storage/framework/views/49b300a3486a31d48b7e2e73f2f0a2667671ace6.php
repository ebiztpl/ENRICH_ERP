                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="role_manage[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="settings[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="Branch[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="Language[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="LedgerType[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="LedgerGroup[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="LedgerName[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="BankCash[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input
                                                                            name="InitialIncomeExpenseHeadBalance[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input
                                                                            name="InitialBankCashBalance[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="dr_voucher[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="cr_voucher[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="jnl_voucher[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="cnt_voucher[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="ledger[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="trial_balance[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="cost_Of_revenue[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input
                                                                            name="profit_or_loss_account[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input
                                                                            name="retained_earning[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input
                                                                            name="fixed_assets_schedule[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input
                                                                            name="statement_of_financial_position[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="cash_flow[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input
                                                                            name="receive_and_payment[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="GeneralBranch[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="GeneralLedger[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="GeneralBankCash[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php for($i = 1; $i <= 9; $i++): ?>
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="GeneralVoucher[<?php echo e($i); ?>]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/enrichapp.co.in/httpdocs/eaccount/resources/views/admin/role-manage/create.blade.php ENDPATH**/ ?>