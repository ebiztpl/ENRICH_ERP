...
<?php $__env->startSection('title'); ?>
    <?php echo e(__('root.reports.profit_or_loss_account_manage')); ?>
...
<?php $__env->startSection('content'); ?>
    <section <?php if($is_rtl): ?> dir="rtl" <?php endif; ?> class="content">
        <div class="header">
            <h2 class="text-center"><?php echo e(__('root.reports.profit_or_loss_account_manage')); ?></h2>
            <br>
        </div>
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <form class="form" id="form_validation" method="post"
                                    action="<?php echo e(route('reports.accounts.profit_or_loss_account.report')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/enrichapp.co.in/httpdocs/eaccount/resources/views/admin/accounts-report/profit-or-loss-account/index.blade.php ENDPATH**/ ?>