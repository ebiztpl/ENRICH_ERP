                    ...
                    <table class="table table-bordered table-sm">
                        <thead>
                            <tr>
                                ...
                                <th class="text-left"><?php echo e($search_by['group_name']); ?></th>
        ...
        <div class="mid">
            <div class="row">
                <?php
                    $grand_total = 0;
                ?>
                <?php $__currentLoopData = $particulars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $groups): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <table class="table table-bordered table-sm table-hover">
                            ...
                            <tbody>
                                <?php
                                    $sub_total = 0;
                                ?>
                                <?php $__currentLoopData = $groups->groupBy('IncomeExpenseHead.name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyHead => $transactions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $head_balance = 0;
                                    ?>
...
<?php echo $__env->make('layouts.pdf', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/enrichapp.co.in/httpdocs/eaccount/resources/views/admin/accounts-report/notes/group-wise/index.blade.php ENDPATH**/ ?>