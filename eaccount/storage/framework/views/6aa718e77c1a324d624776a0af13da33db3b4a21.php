    ...
    <section <?php if($is_rtl): ?> dir="rtl" <?php endif; ?> class="content">
        <div class="container-fluid">
            <div class="block-header <?php if($is_rtl): ?> pull-right <?php else: ?> pull-left <?php endif; ?>">
                <a class="btn btn-sm btn-info waves-effect" href="<?php echo e(route($ParentRouteName)); ?>">Back</a>
            </div>
                        ...
                        <div class="header">
                            ...
                            <div class="body">
                                <form class="form" id="form_validation" method="post"
                                    action="<?php echo e(route($ParentRouteName . '.update', ['id' => $item[0]->id])); ?>">
                                    ...
                                    <div class="row clearfix">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select data-live-search="true" class="form-control show-tick"
                                                        ...
                                                        <?php $__currentLoopData = $branches->sortByDesc('id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option
                                                                <?php if($branch->id == $item[0]->branch_id): ?> )
                                                                        selected <?php endif; ?>
                                                ...
                                                <div class="form-line">
                                                    <select data-live-search="true" class="form-control show-tick"
                                                        ...
                                                        <?php $__currentLoopData = $bank_cashes->sortByDesc('id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bank_cash): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option
                                                                <?php if($bank_cash->id == $item[0]->bank_cash_id): ?> )
                                                                        selected <?php endif; ?>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="<?php echo e($item[0]->cheque_number); ?>" name="cheque_number"
                                    ...
                                    <div class="row dr">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select data-live-search="true"
                                                        ...
                                                        <?php $__currentLoopData = $income_expense_heads->sortByDesc('id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $HeadOfAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option <?php if($HeadOfAccount->id == $item[0]->income_expense_head_id): ?> selected <?php endif; ?>
                                                                value="<?php echo e($HeadOfAccount->id); ?>">
                                                                <?php echo e($HeadOfAccount->name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="<?php echo e($item[0]->amount); ?>" name="amount[]" type="number"
                                    ...
                                    <div class="row dr">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select data-live-search="true"
                                                        ...
                                                        name="income_expense_head_id[]" id="">
                                                        <option value="0"> Select Head of Account Name</option>
                                                        <?php $__currentLoopData = $income_expense_heads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $HeadOfAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option <?php if($HeadOfAccount->id == $headOfAccountID1): ?> selected <?php endif; ?>
                                                                value="<?php echo e($HeadOfAccount->id); ?>">
                                                                <?php echo e($HeadOfAccount->name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="<?php echo e($amount1); ?>" name="amount[]" type="number"
                                                        class="form-control amount">
                                                    <label class="form-label">Amount </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row dr">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select data-live-search="true"
                                                        ...
                                                        <option value="0"> Select Head of Account Name</option>
                                                        <?php $__currentLoopData = $income_expense_heads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $HeadOfAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option <?php if($HeadOfAccount->id == $headOfAccountID2): ?> selected <?php endif; ?>
                                                                value="<?php echo e($HeadOfAccount->id); ?>">
                                                                <?php echo e($HeadOfAccount->name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="<?php echo e($amount2); ?>" name="amount[]" type="number"
                                                        class="form-control amount">
                                                    <label class="form-label">Amount </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row dr">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select data-live-search="true"
                                                        ...
                                                        <option value="0"> Select Head of Account Name</option>
                                                        <?php $__currentLoopData = $income_expense_heads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $HeadOfAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option <?php if($HeadOfAccount->id == $headOfAccountID3): ?> selected <?php endif; ?>
                                                                value="<?php echo e($HeadOfAccount->id); ?>">
                                                                <?php echo e($HeadOfAccount->name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="<?php echo e($amount3); ?>" name="amount[]" type="number"
                                                        class="form-control amount">
                                                    <label class="form-label">Amount </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row dr">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select data-live-search="true"
                                                        ...
                                                        <option value="0"> Select Head of Account Name</option>
                                                        <?php $__currentLoopData = $income_expense_heads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $HeadOfAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option <?php if($HeadOfAccount->id == $headOfAccountID4): ?> selected <?php endif; ?>
                                                                value="<?php echo e($HeadOfAccount->id); ?>">
                                                                <?php echo e($HeadOfAccount->name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="<?php echo e($amount4); ?>" name="amount[]" type="number"
                                                        class="form-control amount">
                                                    <label class="form-label">Amount </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line" id="bs_datepicker_container">
                                                    <input autocomplete="off"
                                                        value="<?php echo e(date('m/d/Y', strtotime($item[0]->voucher_date))); ?>"
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <textarea name="particulars" rows="2" class="form-control no-resize" placeholder="Particulars"><?php echo e($item[0]->particulars); ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/enrichapp.co.in/httpdocs/eaccount/resources/views/admin/dr-voucher/edit.blade.php ENDPATH**/ ?>