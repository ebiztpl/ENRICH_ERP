...
<?php $__env->startSection('title'); ?>
    <?php echo e(__('root.reports.ledger_manage')); ?>
...
<?php $__env->startSection('content'); ?>
    <section <?php if($is_rtl): ?> dir="rtl" <?php endif; ?> class="content">
        <div class="header">
            <h2 class="text-center"><?php echo e(__('root.reports.ledger_manage')); ?></h2>
        </div>
            ...
            <div class="row clearfix">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <form class="form" id="form_validation" method="post"
                                    action="<?php echo e(route('reports_accounts_ledger.branch_wise.report')); ?>">
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <select data-live-search="true" class="form-control show-tick"
                                                    ...
                                                    <option value=""><?php echo e(__('root.reports.select_ledger_name')); ?></option>
                                                    <?php $__currentLoopData = $income_expense_heads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $income_expense_head): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($income_expense_head->id); ?>">
                                                            <?php echo e($income_expense_head->name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="display:none;">
                    <div class="card">
                        <div class="header bg-cyan">
                            <h2>
                                <?php echo e(__('root.reports.ledger_name_wise')); ?>
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <form class="form" id="form_validation" method="post"
                                    action="<?php echo e(route('reports_accounts_ledger.income_expense_head_wise.report')); ?>">
                                    <?php echo e(csrf_field()); ?>
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="card">
                        <div class="header bg-cyan">
                            <h2>
                                <?php echo e(__('root.reports.cash_bank_book_wise')); ?>
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <form class="form" id="form_validation" method="post"
                                    action="<?php echo e(route('reports_accounts_ledger.bank_cash_wise.report')); ?>">
                                    <?php echo e(csrf_field()); ?>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <select data-live-search="true" class="form-control show-tick"
                                                    name="bank_cash_id">
                                                    <option value=""><?php echo e(__('root.reports.select_bank_cash_name')); ?></option>
                                                    <?php $__currentLoopData = $bank_cashes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $BankCash): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($BankCash->id); ?>"><?php echo e($BankCash->name); ?>
                                            ...
                                            <div class="form-line">
                                                <select data-live-search="true" class="form-control show-tick"
                                                    ...
                                                    <?php if($branch_id == 1): ?>
                                                        <option value="0">Select Branch Name</option>
														<?php endif; ?>
                                                    <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/enrichapp.co.in/httpdocs/eaccount/resources/views/admin/accounts-report/ledger/index.blade.php ENDPATH**/ ?>