                        ...
                        <div class="header">
                            ...
                            <div class="body">
                                <form class="form" id="form_validation" method="post"
                                    action="<?php echo e(route($ParentRouteName . '.bill_recievedstore')); ?>" enctype="multipart/form-data" >
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 field_area">
                                                ...
                                                <div class="form-line">
                                                    <select data-live-search="true" class="form-control show-tick"
                                                        ...
                                                        <?php $__currentLoopData = $head; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option <?php if($group->id == old('head')): ?> selected <?php endif; ?>
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input autofocus="" value="<?php echo e(old('bill_no')); ?>" name="bill_no" type="text" id="bill_no" class="form-control">
                                        ...
                                        <div class="form-group form-float">
                                                <div class="form-line" id="bs_datepicker_container">
                                                    <input autocomplete="off" value="<?php echo e(old('bill_date')); ?>"
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input name="gst" id="gst" type="number" value="<?php echo e(old('gst')); ?>" class="form-control amount">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line" id="foc">
                                                    <input name="total_amount" id="total_amount" type="number" value="<?php echo e(old('total_amount')); ?>"    class="form-control amount" >
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                            <div class="form-group form-float">
                                                 <?php if(old('type')): ?>
                                                 <input value="Goods" name="type" type="radio" id="radio_1" class="with-gap radio-col-cyan"  <?php if(old('type') == 'Goods'): ?>  checked="" <?php endif; ?>>
                                                <label for="radio_1">Goods</label>
                                                <input value="Services" name="type" type="radio" id="radio_2" class="with-gap radio-col-cyan"  <?php if(old('type') == 'Services'): ?>  checked="" <?php endif; ?>>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                            <div class="form-group form-float">
                                                ...
                                                <input value="1" name="tds" type="checkbox" id="tds" <?php if(old('tds') == '1'): ?>  checked="" <?php endif; ?>>
                                            ...
                                            <div class="form-group form-float">
                                                ...
                                                <select data-live-search="true" class="form-control show-tick"
                                                        ...
                                                        <?php $__currentLoopData = $expense_paid; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ledg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option <?php if($ledg->id == old('submitted_by')): ?> selected <?php endif; ?>
                                        ...
                                        <div class="form-group form-float">
                                                <div class="form-line" id="bs_datepicker_container">
                                                    <input autocomplete="off" value="<?php echo e(old('submitted_date')); ?>"
                                        ...
                                        <div class="form-group form-float">
                                                <div class="form-line" id="bs_datepicker_container">
                                                    <input autocomplete="off" value="<?php echo e(old('approved_date')); ?>"
...
$('#sub_head').empty();
    $.ajax({
            ...
            success: function(data){  
                ...
                $('#sub_head').append(data);
                $('#sub_head').val("<?php echo e(old('sub_head')); ?>");
                $('#sub_head').selectpicker('refresh');
                $('#add_ledger').hide();
    },
        ...
        $.ajax({
            ...
            success: function(data){  
                $('#ledger').append(data);
                $('#ledger').val("<?php echo e(old('ledger')); ?>");
                $('#ledger').selectpicker('refresh');
    },
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/enrichapp.co.in/httpdocs/eaccount/resources/views/admin/expense/index.blade.php ENDPATH**/ ?>