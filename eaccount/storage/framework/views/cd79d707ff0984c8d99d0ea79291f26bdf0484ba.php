...
<?php $__env->startSection('content'); ?>
    <p class="mid">Printing Date & Time: <?php echo e($extra['current_date_time']); ?></p>
    <div class="mid">
    ...
    <div class="mid">
        <table class="table table-bordered table-sm">
            ...
            <tr>
                ...
                <td class="font-weight-bold"><?php echo e($search_by['branch_name']); ?></td>
                <td class="text-right">Head Of Account:</td>
                <td class="font-weight-bold"><?php echo e($search_by['income_expense_head_name']); ?></td>
                <td class="text-right">From Date:</td>
                <td class="font-weight-bold"><?php echo e($search_by['from']); ?></td>
                <td class="text-right">To Date:</td>
                <td class="font-weight-bold"><?php echo e($search_by['to']); ?></td>
            </tr>
            </thead>
        </table>
...
<?php echo $__env->make('layouts.pdf', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/enrichapp.co.in/httpdocs/eaccount/resources/views/admin/accounts-report/ledger/branch-wise/pdf.blade.php ENDPATH**/ ?>