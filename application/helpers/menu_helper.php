    ...
    {  
        $array = array(
            ...
            'student_information' => array(                
                'student'         => array('search','create','import','disablestudentslist','dropoutstudentslist','multiclass','bulkdelete','view','edit'),                       'onlinestudent'   => array('index','edit'),               
            ...
            'income' => array(                                 
                ...
                'incomehead'    => array('index','edit','incomeheadcategory'),          
                        
            ),
            
            'expense' => array(                                 
                'expense'       => array('index','edit','expensesearch'),             
                'expensehead'   => array('index','edit','expenseheadcategory'),                             
            ),
            'examinations' => array(                                 
            ...
            'communicate' => array(          
                ...
                'mailsms'           => array('compose','compose_sms','compose_whatsapp','index','schedule','email_template','sms_template','whatsapp_template','edit_schedule'),      
            ...
            'library' => array(               
              'book'      => array('getall','edit','index','import','bookcategory','book_location','dropdown_master'),   
                'member'    => array('index','issue','student','teacher','guest'),    
            ), 
            ...
            'inventoryy' => array(               
                'issueitemm'      => array('index','create'),    
                'itemstockk'      => array('index','edit'),    
                'itemm'           => array('index','edit'),    
                'itemcategoryy'   => array('index','edit'),    
                'itemstoree'      => array('index','edit','create'),    
                'itemsupplierr'   => array('index','edit','create'),    
            ), 
            


            'accounts' => array(               
                'source'      => array('accounts_head','laser'),    
            ), 
            ...
            'reports' => array(  
                ...
                'userlog'           => array('index'), 
                'audit'             => array('index','assests_depreciation'),
