                    ...
                    <div class="box-body">
                        ...
                        <div class="">
                            ...
                            <div class="box-header ptbnull row">
                                ...
                                <?php echo form_error('student'); ?></h3></div>
           ...
           data: form_data, // serializes the form's elements.
              ...
              success: function(response) { // your success handler
                if(!response.status){
                    ...
                    initDatatable('student-list','studentfee/ajaxSearch',response.params,[],15);
                


                $('#appendhere').empty();

   if($class_search == 'class_search'){
$.ajax({
           url: '<?php echo site_url('studentfee/allfeescalcaulation') ?>',
           type: "POST",
           dataType:'JSON',
           data: form_data, // serializes the form's elements.
              beforeSend: function () {
