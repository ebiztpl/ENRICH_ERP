...
<!-- custom by ritki -->
<?php if ($student["is_dropout"] == "0") {
                        ?>
                            <?php
                            if ($this->rbac->hasPrivilege('disable_student', 'can_view')) {
                            ?>
<li class="pull-right">
                                    <a style="cursor: pointer;" data-id="1" onclick="dropout_student('<?php echo $student["id"] ?>')" class="text-red" data-toggle="tooltip" data-placement="bottom" title="Dropout">
                                        <i class="fa fa-level-down"></i><?php //echo "Disable Student";   
                                                                            ?>
                                    </a>
                                </li>
                                <?php
...
<?php
                            ...
                            ?>
<li class="pull-right">
                                    <a style="cursor: pointer;" data-id="0" onclick="dropout_disable('<?php echo $student["id"] ?>')" class="text-green" data-toggle="tooltip" data-placement="bottom" title="Remove Dropout">
                                        <i class="fa fa-level-up"></i><?php //echo "Disable Student";   
                                                                            ?>
                                    </a>
                                </li>
...
<!-- custom by ritki -->
                            ...
                            <?php if ($this->module_lib->hasActive('fees_collection')) { ?>
                                <li class="pull-right">
                                    <a href="<?php echo site_url('studentfee/addfee/' . $student["student_session_id"]) ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo $this->lang->line('collect_fees'); ?>"><b><?php echo $currency_symbol; ?><i class="fa fa-money ftlayer"></i> </b>
                                    </a>
                                </li>
