...
<div class="col-md-12 col-xs-12">
    <div class="form-group">
     <b> Note: </b><span style="color:red"> Check checkboxes for seaching their null values respectively :-</span>
    </div>	
<div class="form-group" style="display: flex;justify-content: space-evenly;align-items: center;">	
<label style="cursor:pointer" class="btn btn-success btn-sm " for="lef1"><input type="checkbox" <?php if (set_value('checkkdel1')) echo "checked"; ?> name="checkkdel1" value="admisson" id="lef1"> Admission Date</label>
<label style="cursor:pointer" class="btn btn-success btn-sm " for="lef2"><input type="checkbox" <?php if (set_value('checkkdel2')) echo "checked"; ?> name="checkkdel2" value="city" id="lef2"> City</label>
<label style="cursor:pointer" class="btn btn-success btn-sm " for="lef3"><input type="checkbox" <?php if (set_value('checkkdel3')) echo "checked"; ?>  name="checkkdel3" value="dob" id="lef3"> DOB</label>								
<label style="cursor:pointer" class="btn btn-success btn-sm " for="lef4"><input type="checkbox" <?php if (set_value('checkkdel4')) echo "checked"; ?> name="checkkdel4" value="contact" id="lef4"> Contact no.</label>
<label style="cursor:pointer" class="btn btn-success btn-sm " for="lef5"><input type="checkbox" <?php if (set_value('checkkdel5')) echo "checked"; ?> name="checkkdel5" value="category" id="lef5"> Category</label>
</div>				
</div>						
									
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <button type="submit" name="search" value="search_filter" class="btn btn-primary btn-sm pull-right checkbox-toggle"><i class="fa fa-search"></i> 
                    ...
                    <div class="nav-tabs-custom border0 navnoshadow"  id="showhide" style="display:none">
                      <div class="box-header ptbnull"><b>Total Students : </b><span style="color:green" id="fillcount"></span></div>
...
$(document).on('submit','.class_search_form',function(e){
   e.preventDefault(); // avoid to execute the actual submit of the form.
    ...
    $('.detail_view_tab').html("").html(settings.json.student_detail_view);
		  $('#fillcount').html(settings.json.recordsTotal);
		  $('#showhide').show();
}
