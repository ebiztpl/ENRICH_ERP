...
$count++;
    ...
    ?>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                        <label for="exampleInputEmail1"><?php echo $this->lang->line('invoice_number'); ?>/<?php echo $this->lang->line('voucher_number'); ?></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control" name="payment_mode">
                                         ...
                                         <span class="text-danger"><?php echo form_error('payment_mode_error'); ?></span>
                                        </div>
                                    </div>
                                </div>        
