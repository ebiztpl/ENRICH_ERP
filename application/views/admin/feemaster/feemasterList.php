...
.filter-list label.less {
  color: #f86843;
  font-weight: 600;
  font-style: oblique;
  display: none;
}
.filter-list label.less.showMe {
  display: block;
}
                                        ...
                                        foreach ($feemasterList as $feegroup) {
                                            ...
                                            <tr>
                                                <td class="mailbox-name">
                                                    ...
                                                    <br>
                                                    Applied on '<?=  $studentcount ?>' Students. 
                                                </td>
                                                <td class="mailbox-name filter-list">
                                                    <ul class="liststyle1" >
                                                        <?php
                                                    ...
                                                    <label class="less">...See less</label>
                                                </td>
...
$(document).ready(function () {
  ...
  $(".more").click(function () {
    ...
    $(this).parent(".filter-list").find(".less").addClass("showMe");
  });
});
...
<script>
    $(document).on('click', '.less', function () {
        $(this).removeClass('showMe');
    $(this).parent(".filter-list").find("ul").find("li").removeClass("showList");
    
    $(this).parent(".filter-list").find(".more").addClass("showMe");
