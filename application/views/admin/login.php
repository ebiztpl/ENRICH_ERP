            ...
            <div class="inner-bg">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        ?>  
                        <div class="<?php echo $bgoffsetbg; ?>" style="background: url('<?php echo base_url(); ?>uploads/school_content/login_image/<?php echo $school['admin_login_page_background']; ?>') no-repeat; background-size:cover">  
                                ...
                                <div class="loginbg">  
                                   <div class="form-top" style="padding-bottom:0px;">
                                        <div class="form-top-left logowidth">
                                            <img style="width:100px;" src="<?php echo base_url(); ?>uploads/school_content/admin_logo/<?php echo $this->setting_model->getAdminlogo(); ?>" />    
                                        </div>
                                    </div>
