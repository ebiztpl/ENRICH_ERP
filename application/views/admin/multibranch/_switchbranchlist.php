...
<div class="alert alert-info">
	<?php echo $this->lang->line('no_more_branch_found_if_you_want_to_add_new_branch_please');?> <a href="<?php echo site_url('admin/Admin') ?>"> <?php echo $this->lang->line('click_here');?></a>
</div>
    <div class="row">
        <div class="col-md-12">
            <div class="well well-sm">
