...
<div id="addModal" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static"> 
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-body">
            <form method="POST" class="form_db" action="<?php echo site_url('admin/Admin/add') ?>">
...
<script type="text/javascript">
    ...
    'use strict';
        ...
        $(document).ready(function () {
            ...
            initDatatable('branch-list','admin/Admin/getlist',[],[],100);
           // initDatatable('branch-list','admin/Admin/getlist',[],[],100);
        });
...
$(document).on("click", ".check_branch", function(e) {
   ...
   let id=$(this).data('id');
    $.ajax({
           type: "POST",
           url: baseurl+"admin/Admin/verify",
           data: {
            'host_name' :host_name,
            'database' :database,
            'username' :username,
