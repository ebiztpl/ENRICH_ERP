        ...
        ?> ><?=$drop->name?></option>
                           ...
                           <!--  <div class="clearfix"></div> -->
                            ...
                            <div class="form-group col-md-2" style="<?= $dis ?>" id="showhide">
                                ...
                                <input id="writeoffyear" name="writeoffyear" type="number" min="1900" max="2099" step="1" value=""  class="form-control" >
        ...
        ?> ><?=$drop->name?></option>
                           ...
                           <!--  <div class="clearfix"></div> -->
                            <div class="form-group col-md-3">
                                ...
                                <input id="perunitcost" min="1" name="pages_count" placeholder="" type="text" class="form-control"  value="0" />
