 ...
 //print_r($memberList);die;
    foreach ($memberList as $member) {
        ...
        if ($member['member_type'] == "student") {
            ...
            $email = $member['teacher_email'];
            $name  = $member['teacher_name'] ?? $member['name'];
            $id =  "(" . $member['emp_id'] . ")";
            $sex   = $member['teacher_sex'];
            $phone = $member['contact_no'] ?? $member['teacher_phone'];
...
<a href="<?php echo base_url(); ?>/admin/member/guestedit/<?= $member['staff_id']?>"><?php echo $name; ?></a>
                                             ...
                                             <?php   }
                                                    ...
                                                    <a href="<?php echo base_url(); ?>/admin/staff/profile/<?= $member['staff_id']?>"><?php echo $name; ?> <?php echo $id; ?></a> 
