...
if (!empty($side_list)) {
    ...
    if(($actual_link == "https://madhav.enrichapp.co.in/admin/admin/dashboard") || ($actual_link == "https://madhav.enrichapp.co.in/admin/admin/dashboard#")){
        $cde ='active';
    }else{
        $cde ='';
    }

 echo   '<li class="treeview  '.$cde.'">

    <a href="'.base_url().'admin/admin/dashboard">
        <i class="fa fa-home ftlayer"></i> <span>Dashboard</span> 
    </a>
      </li>';
