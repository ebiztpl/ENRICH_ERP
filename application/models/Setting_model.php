...
class Setting_model extends MY_Model {
    ...
    public function getSetting() {  
        ...
        $this->db->select('
        sch_settings.id,
        sch_settings.enrollment_no,
        sch_settings.school_medium_req,
        sch_settings.last_class_req,
        sch_settings.enrollment_no_req,
        sch_settings.abc_id_req,
        sch_settings.measurement_date_req,
        sch_settings.rte_req,
        sch_settings.state_req,
        sch_settings.subject_option_req,
        sch_settings.subject_option,
        sch_settings.state,
        sch_settings.city,
        ...
        sch_settings.higher_education_req,
        sch_settings.swayam_ref_no_req,
        sch_settings.educational_details_req,
        sch_settings.document_due_req,
        sch_settings.city_req,
        sch_settings.upload_documents_req,
        sch_settings.scholar_ship_form_req,
        sch_settings.middle_name_req,
        sch_settings.last_name_req,
        sch_settings.category_req,
        sch_settings.religion_req,
        sch_settings.caste_req,
        sch_settings.mobile_number_req,
        sch_settings.email_req,
        sch_settings.admission_date_req,
        sch_settings.student_photo_req,
        sch_settings.is_student_house_req,
        sch_settings.blood_group_req,
        sch_settings.stuent_height_req,
        sch_settings.student_weight_req,
        sch_settings.father_name_req,
        sch_settings.father_phone_req,
        sch_settings.father_occupation_req,
        sch_settings.father_photo_req,
        sch_settings.mather_name_req,
        sch_settings.mather_phone_req,
        sch_settings.mather_occupation_req,
        sch_settings.mather_photo_req,
        sch_settings.gurdian_name_req,
        sch_settings.gurdian_phone_req,
        sch_settings.gurdian_religion_req,
        sch_settings.gurdian_email_req,
        sch_settings.gurdian_occupation_req,
        sch_settings.gurdian_photo_req,
        sch_settings.gurdian_address_req,
        sch_settings.guardian_currentaddress_req,
        sch_settings.guardian_permentaddress_req,
        ...
        sch_settings.base_url,
        sch_settings.folder_path,
        sch_settings.attendence_type,
        sch_settings.lang_id,
        sch_settings.is_rtl,
        sch_settings.fee_due_days,
        sch_settings.staff_notification_email,
        sch_settings.class_teacher,
        sch_settings.cron_secret_key,
        sch_settings.timezone,
        sch_settings.online_admission_application_form,
        sch_settings.lib_fine,
        sch_settings.name,
        sch_settings.email,
        sch_settings.biometric,
        sch_settings.biometric_device,
        sch_settings.phone,
        sch_settings.enrollment_no_req,
        sch_settings.roll_number_req,
        ...
        sch_settings.family_mid_number_req,
        sch_settings.abc_id_req,
        sch_settings.apar_id_req,
        sch_settings.adm_prefix,
        sch_settings.adm_start_from,
        languages.language,
        sch_settings.adm_no_digit,
        sch_settings.adm_update_status,
        sch_settings.adm_auto_insert,
        sch_settings.staffid_prefix,
        sch_settings.staffid_start_from,
        sch_settings.staffid_auto_insert,
        sch_settings.staffid_no_digit,
        sch_settings.staffid_update_status,
        sch_settings.superadmin_restriction,
        sch_settings.student_timeline,
        sch_settings.address,
        sch_settings.dise_code,sch_settings.date_format,
        sch_settings.currency,
        sch_settings.currency_place,
        sch_settings.start_month,
        sch_settings.start_week,
        sch_settings.session_id,sch_settings.image,
        sch_settings.theme,sessions.session,online_admission,sch_settings.is_duplicate_fees_invoice,sch_settings.is_student_house,
        sch_settings.is_blood_group,sch_settings.roll_no,sch_settings.lastname,sch_settings.middlename,sch_settings.category,
        sch_settings.cast,sch_settings.religion,sch_settings.mobile_no,sch_settings.student_email,
        sch_settings.admission_date,sch_settings.student_photo,sch_settings.student_height,
        sch_settings.student_weight,sch_settings.measurement_date,sch_settings.father_name,
        sch_settings.father_phone,
        sch_settings.father_occupation,sch_settings.father_pic,sch_settings.mother_name,
        sch_settings.mother_phone,sch_settings.mother_occupation,sch_settings.mother_pic,
        sch_settings.guardian_phone,sch_settings.guardian_name,sch_settings.guardian_relation,
        sch_settings.guardian_email,sch_settings.guardian_pic,sch_settings.guardian_occupation,sch_settings.guardian_address,
        sch_settings.current_address,sch_settings.permanent_address,sch_settings.route_list,
        sch_settings.hostel_id,sch_settings.bank_account_no,sch_settings.bank_name,sch_settings.ifsc_code,
        sch_settings.national_identification_no_aadhaar_no,sch_settings.local_identification_no,sch_settings.rte,
        sch_settings.previous_school_details,sch_settings.student_note,sch_settings.upload_documents,
        sch_settings.staff_designation,sch_settings.staff_department,sch_settings.staff_last_name,
        sch_settings.staff_father_name,sch_settings.staff_mother_name,sch_settings.staff_date_of_joining,
        sch_settings.staff_phone,sch_settings.staff_emergency_contact,
        sch_settings.staff_marital_status,sch_settings.staff_photo,sch_settings.staff_current_address,
        sch_settings.staff_permanent_address,sch_settings.staff_qualification,sch_settings.staff_work_experience,
        sch_settings.staff_note,sch_settings.staff_epf_no,sch_settings.staff_basic_salary,
        sch_settings.staff_contract_type,sch_settings.staff_work_shift,sch_settings.staff_work_location,sch_settings.staff_leaves,
        sch_settings.staff_account_details,sch_settings.staff_social_media,sch_settings.staff_upload_documents,sch_settings.admin_logo,sch_settings.admin_small_logo,sch_settings.mobile_api_url,
        sch_settings.app_primary_color_code,sch_settings.app_secondary_color_code,sch_settings.app_logo,languages.short_code as `language_code`,sch_settings.student_profile_edit,sch_settings.my_question,sch_settings.online_admission_payment,online_admission_amount,
        sch_settings.online_admission_instruction,sch_settings.online_admission_conditions,sch_settings.languages as activelanguage,
        sch_settings.single_page_print as single_page_print, sch_settings.student_barcode,
        sch_settings.staff_barcode,sch_settings.calendar_event_reminder,sch_settings.student_login,sch_settings.parent_login,sch_settings.student_panel_login,
        sch_settings.parent_panel_login,sch_settings.currency_format,sch_settings.exam_result,sch_settings.admin_mobile_api_url,sch_settings.admin_app_primary_color_code,
        sch_settings.admin_app_secondary_color_code,is_student_feature_lock,is_offline_fee_payment,lock_grace_period,sch_settings.collect_back_date_fees,sch_settings.event_reminder,sch_settings.event_reminder,sch_settings.maintenance_mode,currencies.symbol as currency_symbol,currencies.base_price,
        currencies.short_name as currency,currencies.id as currency_id,sch_settings.offline_bank_payment_instruction,sch_settings.admin_login_page_background,
        sch_settings.user_login_page_background,sch_settings.low_attendance_limit,
        sch_settings.scan_code_type,sch_settings.class,sch_settings.section,sch_settings.SSSMID,sch_settings.pen_no,
        sch_settings.apar_id,sch_settings.family_mid_no,sch_settings.school_medium,sch_settings.last_class,sch_settings.abc_id,sch_settings.scholarship_form_no');
