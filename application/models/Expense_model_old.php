...
class Expense_model extends MY_Model
{
    ...
    {
        $this->db->select('expenses.id,expenses.date,expenses.name,expenses.created_by,expenses.approved_by,expenses.paid_by,expenses.payment_mode,expenses.invoice_no,expenses.amount,expenses.documents,expenses.note,expense_head.exp_category,expenses.exp_head_id')->from('expenses');
